...
labs_cats <- tribble(
  ...
  "exposure",
  "Do you have breakfast every weekday?",
  "fruits",
  "Eating fruit",
  "exposure",
  "How many times a week do you usually eat fruits?",
  "sweets",
  "Eating sweets",
  "exposure",
  "How many times a week do you usually eat sweets or chocolate?",
  "family_meal_eve",
  "Family meals in the evening",
  "exposure",
  "How often do you have an evening meal together with your mother or father?",
  "timeexe",
  "Time exercising",
  "exposure",
  "Outside of school hours, how often do you usually exercise?",
  "tvwd",
  "Time watching TV",
  "exposure",
  "How many hours a day on weekdays do you spend watching TV?",
  "playgamewd",
  "Playing computer games",
  "exposure",
  "How many hours a day on weekdays do you spend playing computer games?",
  "bulliedothers",
  "Bullying others",
  "exposure",
  "Have you taken part in bullying others in the last couple of months?",
  "beenbullied",
  "Being bullied",
  "exposure",
  "Have you been bullied in the last couple of months?",
  "cbullmess",
  "",
  "",
  "",
  ...
  "",
  "friends_ph_int",
  "Talk to friends - phone and internet",
  "exposure",
  "How often do you talk to your friends on the phone or internet?",
  "acachieve",
  "",
  "",
  "",
  ...
  "Feeling low",
  "outcome",
  "In the last 6 months, have you often felt low?",
  "nervous",
  "Feeling nervous",
  "outcome",
  "In the last 6 months, have you often felt nervous?",
  "sleepdificulty",
  "Difficulty sleeping",
  "outcome",
  "In the last 6 months, have you often had difficulies getting to sleep?",
  "health",
  "Health",
  "outcome",
  ...
  "Life satisfaction",
  "outcome",
  "How happy do you feel with your life?"
) %>% filter(cat != "")
